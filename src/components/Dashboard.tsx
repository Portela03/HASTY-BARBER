  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Banner: Proprietário sem barbearia */}
        {user.tipo_usuario === 'proprietario' && barbershops.length === 0 && (
          <div className="mb-8 bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl p-8 shadow-2xl border-2 border-amber-400 animate-[fadeInUp_0.5s_ease-out]">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/90 mb-4 leading-relaxed">
                  Você criou sua conta, mas ainda não tem uma barbearia cadastrada. 
                  Clique no botão abaixo para finalizar o cadastro e começar a usar o sistema.
                </p>
                <button
                  onClick={() => navigate('/register/barbershop')}
                  className="bg-white text-amber-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 inline-flex items-center gap-2"
                >
          ...
          {user.tipo_usuario === 'proprietario' && (
            <>
              ...
              <DashboardCard
                ...
                description="Defina horários de funcionamento"
                actionText="Configurar"
                onClick={() => {
                  if (selectedShopId) {
                    navigate(`/barbearias/${selectedShopId}/config`);
                  } else {
                    showError('Selecione uma barbearia primeiro');
                  }
                }}
                badge={onboarding.missingHours ? "Obrigatório" : undefined}
              />
